...
def test_all_cycles_replays_the_complete_recording_as_recorded(tmp_path):
    positions, time_s = _episodes([40])
...
def test_all_cycles_still_refuses_a_reset_inside_the_recording(tmp_path):
